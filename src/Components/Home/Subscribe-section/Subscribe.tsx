        ...
        <div className="Subscribe-section-pt-1  ">
          <div className="flex flex-col gap-4">
            <p className="font-semibold text-[24px] text-white">
              Unlock Exclusive Real Estate Insights!
            </p>
            <span className="font-normal text-[16px] text-white ">
              Get exclusive real estate insights delivered straight to your
              inbox. Sign up now for the latest property listings, market
